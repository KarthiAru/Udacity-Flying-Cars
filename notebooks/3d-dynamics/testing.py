...
def test_exercise_1_1(drone_class):
	...
	print(f"Student: {student.omega}")
	print(f"Solution: {solution.omega}")
...
def test_exercise_1_3(drone_class):
	...
	print(f"acc_stu:{acc_stu}")
	print(f"acc_stu:{acc_sol}")
...
def test_exercise_2_1(drone_class):
	...
	print(f"OD_stu:{OD_stu}")
	print(f"OD_sol:{OD_sol}")
...
def test_exercise_3_1(drone_class):
	...
	print(f"ED_stu:{ED_stu}")
	print(f"ED_sol:{ED_sol}")
