...
sys.path.append(
    "/Users/ka/Documents/Learning/Flying Cars and Autonomous Flight Engineer/projects/udacidrone"
)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--allow_diagonal", type=int, default=0, help="Allow drone to move diagonally"
    )
    parser.add_argument("--prune", type=int, default=0, help="Prune points in the path")
    parser.add_argument(
        "--target",
        type=float,
        nargs=3,
